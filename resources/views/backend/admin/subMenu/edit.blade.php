...
@section('contentBody')
    <div class="row gutter-20">
        ...
        {{ Form::model($sub_menu,['route'=>['sub_menu.update',$sub_menu->id],'method'=>'PUT','files'=>true]) }}
        <!-- Panel Start -->
            <div class="panel">
                <div class="panel-heading p-sm-4">
                    <h3 class="panel-title text-primary" style="font-size: 25px">Submenu Edit Form</h3>
                </div>
                @include('backend.admin.layouts._validation_messages')

                <div class="panel-content">
                    @include('backend.admin.subMenu._form')
